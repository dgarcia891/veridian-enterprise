...
const costComparisonData = [
  ...
  { name: "AI Agent", cost: 3000, color: "hsl(var(--chart-2))" },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="glass-card p-8 rounded-lg mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            {/* Result Display */}
            <div className="bg-accent/30 rounded-lg p-8 text-center border-2 border-destructive/50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* ROI Card */}
          <div className="glass-card p-8 rounded-lg flex flex-col justify-center text-center border-t-4 border-chart-2">
            <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-2">
              Average 1st Year ROI
            </div>
            <div className="text-6xl font-extrabold text-chart-2 mb-4">
              300%+
            </div>

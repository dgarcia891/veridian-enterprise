...
const kpiData = [{
  ...
  value: "$126,000",
  description: "Average revenue lost from unanswered calls.",
  icon: TrendingDown
}, {
  title: "Customers Who Won't Call Back",
  value: "85%",
  description: "They don't leave voicemail. They hang up.",
  icon: PhoneMissed
}, {
  title: "Callers Who Go to a Competitor",
  value: "62%",
  description: "Your missed call is their new customer.",
  icon: AlertCircle
}];

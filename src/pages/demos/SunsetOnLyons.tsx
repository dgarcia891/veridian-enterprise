                ...
                <div className="lg:col-span-2">
                  <div className="bg-card border rounded-lg p-8 min-h-[600px] flex items-center justify-center">
                    <div className="text-center max-w-md">
                      ...
                      <h3 className="text-2xl font-bold mb-2">AI Widget Integration Area</h3>
                      <p className="text-muted-foreground mb-6">
                        The AI chat widget will appear here once integrated. 
                        This space is reserved for the voice AI agent that will handle customer inquiries.
                      </p>
                      <div className="inline-block px-4 py-2 bg-primary/5 rounded-lg text-sm">
                        <span className="text-primary font-semibold">Status:</span> Ready for widget integration
                      </div>
                    </div>
                  </div>
                </div>

        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-white/70">
            <section>
              ...
              <p className="mb-6">
                At Veridian, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
            </section>

      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <section className="space-y-6 text-white/80">
          <div>
            ...
            <p>
              By accessing and using Veridian's services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these terms, please do not use our services.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              All content, features, and functionality of our services are owned by Veridian and are protected by international copyright, trademark, and other intellectual property laws.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Veridian shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use our services.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Veridian operates, without regard to its conflict of law provisions.
            </p>
          </div>
